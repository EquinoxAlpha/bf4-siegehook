...
bool VehicleData::IsTVMissile() {
	auto pFire = *reinterpret_cast<WeaponFiring**>(OFFSET_FIRING_WEAPON);
...
vec3 VehicleTurret::GetVehicleCameraOrigin()
{
	return vec3();
}

vec3 VehicleTurret::GetVehicleCrosshair()
{
	return vec3();
}
